...
class Cube:
	...
	def get_vao(self):
		vao = self.ctx.vertex_array(self.shader_program, [(self.vbo, '2f 3f 3f',
	...
	def get_shader_program(self, shader_name):
		with open(f'shaders/{shader_name}_vert.glsl') as file:
			vertex_shader = file.read()

		with open(f'shaders/{shader_name}_frag.glsl') as file:
